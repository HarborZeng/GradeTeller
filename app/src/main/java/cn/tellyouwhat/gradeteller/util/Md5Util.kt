package cn.tellyouwhat.gradeteller.util
...
object MD5Util {
    ...
    fun getMD5String(str: String): String {
        val bytes: ByteArray = try {
            ...
            md5.digest(str.toByteArray(charset("UTF-8")))
     ...
     * @return 加盐md5
     */
    fun getMD5WithSalt(str: String, salt: String): String {
        return getMD5String(getMD5String(str) + salt)
    }

    fun getMd5StringWithSaltSimple(str: String, salt: String): String {
        return getMD5String(str + salt)
    }
